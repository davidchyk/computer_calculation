...
2. program_branch - спеціалізована гілка, на якій розміщений суто код для console та gui програм. На ній працюватимуть: [artem](https://github.com/davidchyk), [ivan](https://github.com/VanDiesel123)
