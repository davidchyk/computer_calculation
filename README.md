...
2. program_branch - спеціалізована гілка, на якій розміщений суто код для console та gui програм. На ній працюватимуть: [artem](https://github.com/davidchyk), [max](https://github.com/MasterGun2006), [andrey](https://github.com/coffer-45), [ivan]()
